...
const Head = () => {
  ...
  return (
    <div className='grid grid-flow-col p-3 m-2 shadow-lg'>
       ...
       {/* <a href="/">     <img className='h-8 mx-2' alt='youtube-logo' src='https://encrypted-tbn0.gstatic.com/
            images?q=tbn:ANd9GcRzs7d1nlxerknIa7Ajtp1dwrRknLGo-4oZ7A&usqp=CAU' />
      </a> */}
        </div>

        <div className="middle-div col-span-10 self-center text-center">
              <input type='text' className="w-1/2 border border-gray-400 py-1  rounded-l-full" />
        ...
        <div className='right-div col-span-1'>
           <img  className='h-8' alt="user-logo" src="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAHw
